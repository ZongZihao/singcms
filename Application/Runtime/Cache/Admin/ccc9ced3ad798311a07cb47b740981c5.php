  ...
  <ul class="nav navbar-right top-nav">
    ...
    <li class="dropdown">
      ...
      <ul class="dropdown-menu">
        ...
        <li class="divider"></li>
        <li>
          <a href="/admin/login/loginout"><i class="fa fa-fw fa-power-off"></i> 退出</a>
        </li>
      </ul>
    </li>
  </ul>
                    ...
                    <div class="col-md-3">
                        <div class="input-group">
                            ...
                            <select class="form-control" name="catid">
                                ...
                                <?php if(is_array($webSiteMenu)): $i = 0; $__LIST__ = $webSiteMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sitenav): $mod = ($i % 2 );++$i;?><option value="<?php echo ($sitenav["menu_id"]); ?>"
                                    <?php if(($conds["catid"]) == $sitenav["menu_id"]): ?>selected="selected"<?php endif; ?>
                                    ><?php echo ($sitenav["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <form id="singcms-listorder">
                            <table class="table table-bordered table-hover singcms-table">
                                ...
                                <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><span attr-status="<?php if($new["status"] == 1): ?>0<?php else: ?>1<?php endif; ?>"
                                                  attr-id="<?php echo ($new["news_id"]); ?>" class="sing_cursor singcms-on-off"
